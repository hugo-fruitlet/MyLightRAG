...
from lightrag.llm.zhipu import zhipu_complete_if_cache, alinlp_embedding # new
...
async def process_with_rag(
    ...
    try:
        ...
        embedding_func=EmbeddingFunc(
            ...
            func=lambda texts: alinlp_embedding(
...
def main():
    ...
    parser.add_argument("file_path", help="Path to the document to process"
                        ,nargs="?", # new
                        default=f"C:\d\Program Files\workspace\LightRAG\dataSource\\notes_without_project.docx") # new
    parser.add_argument(
